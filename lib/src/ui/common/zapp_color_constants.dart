...
class ZappColorConstants {
  ...
  static const secondaryTextLight = Color.fromARGB(255, 160, 154, 137);
  static const secondaryTextDark = Color.fromARGB(255, 232, 228, 220);

  static const primaryColorLight = Color.fromARGB(255, 255, 115, 0);
  static const primaryColorDark = Color.fromARGB(255, 255, 145, 54);
}
